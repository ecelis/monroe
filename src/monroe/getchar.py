...
1. This LICENSE AGREEMENT is between the Python Software Foundation ("PSF"), and
   ...
   3.10.6 software in source or binary form and its associated documentation.
...
2. Subject to the terms and conditions of this License Agreement, PSF hereby
   ...
   Reserved" are retained in Python 3.10.6 alone or in any derivative version
...
5. PSF SHALL NOT BE LIABLE TO LICENSEE OR ANY OTHER USERS OF PYTHON 3.10.6
   ...
   MODIFYING, DISTRIBUTING, OR OTHERWISE USING PYTHON 3.10.6, OR ANY DERIVATIVE
